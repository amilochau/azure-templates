...
var workbookData = loadJsonContent('./resources.json')
var workbookDisplayNamePrefix = 'Resources Monitoring'
...
resource workbook 'Microsoft.Insights/workbooks@2022-04-01' = {
  name: guid('${conventions.naming.prefix}${conventions.naming.suffixes.monitorWorkbook}-resources')
  location: location
  tags: referential
  kind: 'shared'
  properties: {
